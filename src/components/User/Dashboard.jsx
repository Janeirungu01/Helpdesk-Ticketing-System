...
// const Dashboard = () => {
//   return (
//     <div className="bg-white bg-cover p-6 text-gray-600">
//       <h1 className="text-2xl font-bold mb-2 text-center">View Tickets</h1>
        ...
        <div className="  text-gray-600 ">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-300">
              <h3 className="text-base/8  text-gray-600">
                Open Tickets
              </h3>
