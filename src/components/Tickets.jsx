...
//       ...tickets.filter(
//         (incoming) =>
//           !storedTickets.some((stored) => stored.ticketId === incoming.ticketId)
//       ),
//     ].map((ticket) => ({
//       ...ticket,
...
//                 <td
//                   className={`p-2 border text-white font-bold text-center ${
...
//                   </span>
//                 </td>
//                 {/* <td className="p-2 border">{ticket.notes || "-"}</td> */}
  ...
  const ticketRows = useMemo(() =>
    ticketList.map((ticket) => (
      <tr key={ticket.ticketId} className="text-gray-700">
        ...
        <td className={`p-2 border text-white font-bold text-center ${getPriorityClass(ticket.priority)}`}>
          {ticket.priority}
        </td>
        <td className="p-2 border text-center">
          <span
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-blue-100 bg-opacity-25 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <p className="text-gray-600 mb-4">
              Are you sure you want to mark <span className="font-bold">{selectedTicket.subject}</span> as resolved?
            </p>
            <textarea
              value={notes}
              onChange={(e) => setNotes(e.target.value)}
